...
class XmlLessPageMapperProxy<T>(private val sqlSession: SqlSession,
                                ...
                                private val methodCache: MutableMap<Method, PageMapperMethod>)
  ...
  private fun cachedMapperMethod(method: Method): PageMapperMethod {
    var mapperMethod: PageMapperMethod? = methodCache[method]
