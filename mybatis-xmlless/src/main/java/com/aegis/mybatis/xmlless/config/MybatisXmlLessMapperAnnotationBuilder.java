...
import static org.apache.ibatis.binding.MapperMethod.ParamMap;
 ...
 * @since 2017-01-04
 */
public class MybatisXmlLessMapperAnnotationBuilder extends MapperAnnotationBuilder {
  ...
  public MybatisXmlLessMapperAnnotationBuilder(Configuration configuration, Class<?> type) {
    // 执行父类
...
//      }
      for (Method method : methods) {
        ...
        } catch (IncompleteElementException ex) {
  ...
  private LanguageDriver getLanguageDriver(Method method) {
    ...
    return assistant.getConfiguration().getLanguageDriver(langClass);
  }
